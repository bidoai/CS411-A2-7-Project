...
app.config['MYSQL_DATABASE_PASSWORD'] = 'disney'
app.config['MYSQL_DATABASE_DB'] = 'CS411A7'
...
SPOTIFY_APP_ID = '2a840f23bee44aca8b9c621114686051'
SPOTIFY_APP_SECRET = '7ae55085d9b4442fac5c0d039f2196f1'
...
def spotify_authorized():
    ...
    for x in range(len(genres)):
        request_link = "https://www.eventbriteapi.com/v3/events/search/?token=EY7NMX46QFHVATSDF5A6&q=" + quote(genres[x], safe='') + "&sort_by=date&categories=103&start_date.keyword=this_week"
        response = s.get(
        ...
        for i in data['events']:
            ...
            city_request_link = "https://www.eventbriteapi.com/v3/venues/" + i['venue_id'] + "/?token=EY7NMX46QFHVATSDF5A6"
    ...
    tm_client = ticketpy.ApiClient('yWWRGQY9J08hbGuPm45KgaT7qzTKHqgt')
    ...
    #image_urls = ['https://i.scdn.co/image/7c930e4e48d01a1e5efbd525f5d2feb9cf1bd364', 'https://i.scdn.co/image/b79cd41a994aed08c8c27d56702bd20048e92901', 'https://i.scdn.co/image/0187a02379ba8677b56f65950ee4e32e213c26e5', 'https://i.scdn.co/image/7b45e618a057dfcad3202190e165956f52eb8004', 'https://i.scdn.co/image/32f4515ff2426fe1e2256cadef56783bfaeb52bd']
